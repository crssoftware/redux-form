...
describe('createReduxForm', function () {
  ...
  it('should render without error', function () {
    ...
    (0, _expect2.default)(function () {
      ...
      renderIntoDocument(_react2.default.createElement(
  ...
  it('should pass fields as props', function () {
    ...
    var dom = renderIntoDocument(_react2.default.createElement(
      _reactRedux.Provider,
      { store: store },
      _react2.default.createElement(Decorated, null)
    ));
  ...
  it('should only initialize on mount once', function () {
    ...
    var dom2 = renderIntoDocument(_react2.default.createElement(
      _reactRedux.Provider,
      { store: store },
      _react2.default.createElement(Decorated, { initialValues: { name: 'Bob' } })
    ));
  ...
  it('should not replace existing values when initialValues changes if overwriteOnInitialValuesChange is set to false', function () {
    ...
    var StatefulContainer = function (_Component9) {
      ...
      function StatefulContainer(props) {
        ...
        var _this10 = _possibleConstructorReturn(this, _Component9.call(this, props));
  ...
  it('should replace existing values when initialValues changes', function () {
    ...
    var StatefulContainer = function (_Component10) {
      ...
      function StatefulContainer(props) {
        ...
        var _this11 = _possibleConstructorReturn(this, _Component10.call(this, props));

        _this11.starrMe = _this11.starrMe.bind(_this11);
        _this11.state = {
          beatle: { firstName: 'John', lastName: 'Lennon' }
        };
        return _this11;
  ...
  it('should provide a submit() method to submit the form', function () {
    ...
    var Container = function (_Component11) {
      ...
      function Container(props) {
        ...
        var _this12 = _possibleConstructorReturn(this, _Component11.call(this, props));
  ...
  it('submitting from parent should fail if sync validation errors', function () {
    ...
    var Container = function (_Component12) {
      ...
      function Container(props) {
        ...
        var _this13 = _possibleConstructorReturn(this, _Component12.call(this, props));

        _this13.submitFromParent = _this13.submitFromParent.bind(_this13);
        return _this13;
      }
  ...
  it('should throw when trying to access the wrapped instance if forwardRef is not specified', function () {
    var store = makeStore();
    ...
    }).toThrow(/To access the wrapped instance, you need to specify \{ forwardRef: true \} as the fourth argument of the connect\(\) call\./);
  });
  ...
  it('should return the instance of the wrapped component for use in calling child methods', function () {
    ...
    (0, _expect2.default)(decorated.refs.wrappedInstance.refs.wrappedInstance.refs.wrappedInstance.someInstanceMethod()).toBe(someData);
  });
